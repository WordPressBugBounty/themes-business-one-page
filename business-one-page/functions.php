...
function business_one_page_admin_notice(){
    ...
    $dismissnonce = wp_create_nonce( 'business_one_page_admin_notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><a href="<?php echo esc_url( admin_url( 'themes.php?page=business-one-page-dashboard' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Go to the Dashboard.', 'business-one-page' ); ?></a></p>
                    <p class="dismiss-link"><strong><a href="?business_one_page_admin_notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss', 'business-one-page' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function business_one_page_update_admin_notice(){
    ...
    if ( isset( $_GET['business_one_page_admin_notice'] ) && $_GET['business_one_page_admin_notice'] = '1' && wp_verify_nonce( $_GET['_wpnonce'], 'business_one_page_admin_notice' ) ) {
